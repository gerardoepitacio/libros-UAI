...
<p id="error" class="warning">Ups! Usuario no identificado, verifica tus datos.</p>
						
		<a href="index.php" class="link-button"><span>Volver</span></a>
		<a href="agregarNuevoUsuario.php" class="link-button"><span>Regristrarme</span></a>
