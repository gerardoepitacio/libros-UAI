					...
					<div class="front-left-col">
						...
						<ul class="news-list">
							...
							<li>
								...
								<?php echo $row_publicacion['nombre']; ?> Comenta <?php echo $row_publicacion['titulo']; ?></div>
				            ...
				            <li>
								...
								<?php echo $row_publicacion['tPublicacion']; ?>
						...
						if($numComents = mysql_fetch_assoc($comentarios)){
							$resultado = $numComents['total'] ;
							  ...
							  echo $row_publicacion['hora']; 
								echo "<p style= align=\"left\">" .  $resultado ." Comtentarios </p>"; 							  
